...
// QueryNamespaces queries the "namespaces" edge of the User entity.
func (_m *User) QueryNamespaces() *NamespaceQuery {
	return NewUserClient(_m.config).QueryNamespaces(_m)
}
