...
func (_u *UserUpdate) AddNamespaceIDs(ids ...int) *UserUpdate {
	_u.mutation.AddNamespaceIDs(ids...)
	return _u
}

// AddNamespaces adds the "namespaces" edges to the Namespace entity.
func (_u *UserUpdate) AddNamespaces(v ...*Namespace) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.NamespacesCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.NamespacesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddNamespaceIDs adds the "namespaces" edge to the Namespace entity by IDs.
func (_u *UserUpdateOne) AddNamespaceIDs(ids ...int) *UserUpdateOne {
	_u.mutation.AddNamespaceIDs(ids...)
	return _u
}

// AddNamespaces adds the "namespaces" edges to the Namespace entity.
func (_u *UserUpdateOne) AddNamespaces(v ...*Namespace) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearNamespaces clears all "namespaces" edges to the Namespace entity.
func (_u *UserUpdateOne) ClearNamespaces() *UserUpdateOne {
	_u.mutation.ClearNamespaces()
	return _u
}

// RemoveNamespaceIDs removes the "namespaces" edge to Namespace entities by IDs.
func (_u *UserUpdateOne) RemoveNamespaceIDs(ids ...int) *UserUpdateOne {
	_u.mutation.RemoveNamespaceIDs(ids...)
	return _u
}

// RemoveNamespaces removes "namespaces" edges to Namespace entities.
func (_u *UserUpdateOne) RemoveNamespaces(v ...*Namespace) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
